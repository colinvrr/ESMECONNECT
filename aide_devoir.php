...
<Center><h1>Liste des annonces de devoirs</h1></center>
    ...
    <Center><h3>En renseignant les informations de l'annonce d'aide et nous vous redirigerons vers le propriétaire.</h3></center>
    ...
    <div class="container">
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) { 
                ...
                if($_SESSION['login'] == 'admin.root@esme.fr' and $_SESSION['mot_passe'] == 'root123'){
                    ...
                    echo "<form action=\"sup_devoir.php?id=$row[id]\" method=\"post\" >
        ...
        <center><a href="create_devoir.php" class="btn btn-primary">Créer une annonce</a></center>
        <br>       <br>       <br>       <br>       <br>
    </div>
