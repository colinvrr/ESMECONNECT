...
<head>
    ...
    <Center><h1>Liste des annonces de logements</h1></center>
    <Center><h3>Si un logement vous intéresse n'hésitez pas à contacter l'adresse mail : <a href="mailto:admin_esmeconnect@esme.fr">admin_esmeconnect@esme.fr</a></h3></center>
    ...
    <div class="container">
        ...
        <center><a href="create_logement.php" class="btn btn-primary">Créer une annonce</a></center>
        <br>       <br>       <br>       <br>       <br>
    </div>
